...
public static class EventHandler
{
    ...
    //洒水器在土地状态更新之后
    public static event Action<int, Season> GameDayEvent1;
    public static void CallGameDayEvent1(int day, Season season)
    {
        GameDayEvent1?.Invoke(day, season);
    }
    ...
    public static void CallGamePauseEvent()
    {
        GamePauseEvent?.Invoke();
    }    
    public static event Action GameResumeEvent;
    public static void CallGameResumeEvent()
    {
